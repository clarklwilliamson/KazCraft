...
local SAVED_BOX_LAYOUT = {
    ...
    [100907] = { x = 175, y = -245 },
    [100939] = { x = 490, y = -250 },
    -- Blacksmithing (4 trees — top: Everburning Forge+Means of Production, bottom: Weaponsmithing+Armorsmithing)
    [99267] = { x = 0, y = 0 },
    [99589] = { x = 320, y = -75 },
    [99453] = { x = -115, y = 250 },
    [99239] = { x = 320, y = 250 },
    -- Leatherworking (4 trees — top: Flawless Fortes+Learned Leatherworker, bottom: Concrete Chitin+Luxurious Leathers)
    [97640] = { x = 0, y = 0 },
    [97712] = { x = 5, y = 255 },
    [97784] = { x = -435, y = 255 },
    [97560] = { x = -350, y = 10 },
    -- Inscription (4 trees — top: Pursuit of Knowledge+Pursuit of Perfection, bottom: Archival Additions+Careful Carvings)
    [101595] = { x = 0, y = 0 },
    [101627] = { x = 315, y = 0 },
    [101563] = { x = 325, y = 250 },
    [101881] = { x = -125, y = 255 },
    -- Alchemy (4 trees — Alchemical Mastery+Fantastic Flasks+Potent Potions+Thaumaturgy)
    [99020] = { x = 0, y = 0 },
    [98953] = { x = -260, y = -135 },
    [99041] = { x = -195, y = 55 },
    [99059] = { x = -290, y = 250 },
    -- Jewelcrafting (3 trees — Gemcutting+Jewelrycrafting+Shaping)
    [98614] = { x = 0, y = 0 },
    [98245] = { x = -315, y = 5 },
    [98666] = { x = -315, y = 255 },
    -- Alchemy Midnight (4 trees — Potion Prowess+Fluent in Flasks+Alchemical Mastery+Transmutation Authority)
    [107107] = { x = 0, y = 0 },
    [107214] = { x = 440, y = 0 },
    [107284] = { x = 110, y = -240 },
    [107257] = { x = 445, y = -245 },
    -- Jewelcrafting Midnight (4 trees — Thoughtful Throughput+Glamorous Gems+Alluring Accessories+Proficient Processor)
    [107015] = { x = 0, y = 0 },
    [106901] = { x = 350, y = -350 },
    [107059] = { x = 5, y = -300 },
    [106983] = { x = 365, y = 10 },
    -- Blacksmithing Midnight (4 trees — Craftsmithing+The Old Ways+Armorsmithing+Weaponsmithing)
    [104258] = { x = 0, y = 0 },
    [104292] = { x = -340, y = 15 },
    [104576] = { x = 0, y = 250 },
    [104633] = { x = -405, y = 250 },
    ...
    [109660] = { x = -440, y = 310 },
    [106358] = { x = 15, y = 315 },
    -- Leatherworking Midnight (4 trees — Learned Leatherworker+Lasting Leather+Safeguarding Scales+Flawless Fortes)
    [107921] = { x = 0, y = 0 },
    [107889] = { x = -140, y = 230 },
    [107993] = { x = 315, y = 230 },
    [107817] = { x = 315, y = -90 },
    -- Tailoring Midnight (4 trees — Sin'dorei Finery+Nimble Needlework+Fabric Specialist+Fiber Arts)
    [104216] = { x = 0, y = 0 },
    [104328] = { x = -395, y = 35 },
    [104350] = { x = -290, y = -210 },
    [104390] = { x = -15, y = -250 },
...
local SAVED_POSITIONS = {
    ...
    [101790] = { x = 180, y = 65 },
    [101789] = { x = 180, y = 5 },
    -- Tailoring: From Dawn Until Dusk (root 100306)
    [100306] = { x = 0, y = 0 },
    [100305] = { x = -55, y = 60 },
    [100304] = { x = -110, y = 120 },
    [100303] = { x = 50, y = 60 },
    [100302] = { x = 105, y = 120 },
    -- Tailoring: Quality Fabric (root 100907)
    [100907] = { x = 0, y = 0 },
    [100906] = { x = -60, y = 65 },
    [100905] = { x = 0, y = 65 },
    [100904] = { x = 60, y = 65 },
    -- Tailoring: Textile Treasures (root 100939)
    [100939] = { x = 0, y = 0 },
    [100938] = { x = -55, y = 60 },
    [100937] = { x = 0, y = 65 },
    [100936] = { x = 60, y = 60 },

    -- Blacksmithing: Everburning Forge (root 99267)
    [99267] = { x = 0, y = 0 },
    [99266] = { x = -55, y = 60 },
    [99265] = { x = 0, y = 60 },
    [99264] = { x = 60, y = 60 },
    -- Blacksmithing: Means of Production (root 99589)
    [99589] = { x = 0, y = 0 },
    [99588] = { x = -105, y = 5 },
    [99587] = { x = -200, y = 0 },
    [99586] = { x = -195, y = 70 },
    ...
    [99581] = { x = 195, y = 70 },
    [99580] = { x = 195, y = 0 },
    -- Blacksmithing: Weaponsmithing (root 99453)
    [99453] = { x = 0, y = 0 },
    [99452] = { x = -75, y = 5 },
    [99451] = { x = -165, y = 0 },
    [99450] = { x = -165, y = 70 },
    [99449] = { x = 85, y = 0 },
    [99448] = { x = 170, y = 0 },
    -- Blacksmithing: Armorsmithing (root 99239)
    [99239] = { x = 0, y = 0 },
    [99238] = { x = -95, y = 0 },
    [99237] = { x = -195, y = 5 },
    [99236] = { x = -190, y = 80 },
    ...
    -- Jewelcrafting Midnight: Thoughtful Throughput (root 107015)
    [107015] = { x = 0, y = 0 },
    [107014] = { x = -53, y = 6 },
    [107013] = { x = 2, y = 56 },
    [107012] = { x = 57, y = 1 },
    -- Jewelcrafting Midnight: Glamorous Gems (root 106901)
    [106901] = { x = 0, y = 0 },
    [106900] = { x = -52, y = 0 },
    [106899] = { x = -127, y = 0 },
    [106898] = { x = -127, y = 50 },
    ...
    [106885] = { x = 143, y = 50 },
    [106884] = { x = 143, y = -5 },
    -- Jewelcrafting Midnight: Alluring Accessories (root 107059)
    [107059] = { x = 0, y = 0 },
    [107058] = { x = -53, y = 1 },
    [107057] = { x = 2, y = 56 },
    [107056] = { x = 52, y = 1 },
    -- Jewelcrafting Midnight: Proficient Processor (root 106983)
    [106983] = { x = 0, y = 0 },
    [106982] = { x = -57, y = 61 },
    [106981] = { x = -122, y = 6 },
    [106980] = { x = -122, y = 66 },
    ...
    -- Alchemy Midnight: Potion Prowess (root 107107)
    [107107] = { x = 0, y = 0 },
    [107106] = { x = -21, y = 61 },
    [107105] = { x = -76, y = 1 },
    [107104] = { x = -76, y = 61 },
    ...
    [107102] = { x = 89, y = 61 },
    [107101] = { x = 89, y = 1 },
    -- Alchemy Midnight: Fluent in Flasks (root 107214)
    [107214] = { x = 0, y = 0 },
    [107213] = { x = -26, y = 61 },
    [107212] = { x = -76, y = 6 },
    [107211] = { x = -76, y = 61 },
    ...
    [107209] = { x = 74, y = 61 },
    [107208] = { x = 74, y = 6 },
    -- Alchemy Midnight: Alchemical Mastery (root 107284)
    [107284] = { x = 0, y = 0 },
    [107283] = { x = -53, y = 1 },
    [107282] = { x = 2, y = 56 },
    [107281] = { x = 52, y = 1 },
    -- Alchemy Midnight: Transmutation Authority (root 107257)
    [107257] = { x = 0, y = 0 },
    [107256] = { x = -53, y = 1 },
    [107255] = { x = 2, y = 56 },
    [107254] = { x = 52, y = 1 },

    -- Blacksmithing Midnight: Craftsmithing (root 104258)
    [104258] = { x = 0, y = 0 },
    [104257] = { x = -53, y = 1 },
    [104256] = { x = 2, y = 56 },
    [104255] = { x = 52, y = 1 },
    -- Blacksmithing Midnight: The Old Ways (root 104292)
    [104292] = { x = 0, y = 0 },
    [104291] = { x = -55, y = 1 },
    [104290] = { x = -30, y = 56 },
    [104289] = { x = 30, y = 56 },
    [104288] = { x = 55, y = 1 },
    -- Blacksmithing Midnight: Armorsmithing (root 104576)
    [104576] = { x = 0, y = 0 },
    [104575] = { x = -47, y = 61 },
    [104574] = { x = -102, y = 6 },
    [104573] = { x = -102, y = 61 },
    ...
    [104565] = { x = 113, y = 61 },
    [104564] = { x = 113, y = 6 },
    -- Blacksmithing Midnight: Weaponsmithing (root 104633)
    [104633] = { x = 0, y = 0 },
    [104632] = { x = -53, y = 1 },
    [104631] = { x = -108, y = 1 },
    [104630] = { x = -53, y = 56 },
    ...
    -- Leatherworking: Learned Leatherworker (root 97640)
    [97640] = { x = 0, y = 0 },
    [97639] = { x = -60, y = 0 },
    [97638] = { x = 5, y = 65 },
    [97637] = { x = 70, y = 5 },
    -- Leatherworking: Luxurious Leathers (root 97712)
    [97712] = { x = 0, y = 0 },
    [97711] = { x = -25, y = 100 },
    [97710] = { x = -105, y = 5 },
    [97709] = { x = -110, y = 65 },
    ...
    [97703] = { x = 120, y = 60 },
    [97702] = { x = 120, y = 0 },
    -- Leatherworking: Concrete Chitin (root 97784)
    [97784] = { x = 0, y = 0 },
    [97783] = { x = -30, y = 90 },
    [97782] = { x = -105, y = 5 },
    [97781] = { x = -105, y = 55 },
    ...
    [97775] = { x = 105, y = 55 },
    [97774] = { x = 105, y = 0 },
    -- Leatherworking: Flawless Fortes (root 97560)
    [97560] = { x = 0, y = 0 },
    [97559] = { x = -80, y = 0 },
    [97558] = { x = -75, y = 65 },
    [97557] = { x = 0, y = 70 },
    ...
    -- Inscription: Pursuit of Knowledge (root 101595)
    [101595] = { x = 0, y = 0 },
    [101594] = { x = -75, y = 0 },
    [101593] = { x = 0, y = 65 },
    [101592] = { x = 75, y = 0 },
    -- Inscription: Pursuit of Perfection (root 101627)
    [101627] = { x = 0, y = 0 },
    [101626] = { x = -65, y = 0 },
    [101625] = { x = 0, y = 70 },
    [101624] = { x = 65, y = 0 },
    -- Inscription: Careful Carvings (root 101563)
    [101563] = { x = 0, y = 0 },
    [101562] = { x = -30, y = 65 },
    [101561] = { x = -95, y = 65 },
    [101560] = { x = -30, y = 140 },
    ...
    [101557] = { x = 95, y = 140 },
    [101556] = { x = 95, y = 65 },
    -- Inscription: Archival Additions (root 101881)
    [101881] = { x = 0, y = 0 },
    [101880] = { x = 0, y = 90 },
    [101879] = { x = -90, y = 30 },
    [101878] = { x = -90, y = 90 },
    ...
    -- Alchemy: Alchemical Mastery (root 99020)
    [99020] = { x = 0, y = 0 },
    [99019] = { x = -65, y = 0 },
    [99018] = { x = -65, y = 60 },
    [99017] = { x = 0, y = 65 },
    [99016] = { x = 65, y = 65 },
    [99015] = { x = 60, y = 0 },
    -- Alchemy: Fantastic Flasks (root 98953)
    [98953] = { x = 0, y = 0 },
    [98952] = { x = -80, y = 0 },
    [98951] = { x = 85, y = -5 },
    -- Alchemy: Potent Potions (root 99041)
    [99041] = { x = 0, y = 0 },
    [99040] = { x = 60, y = 0 },
    -- Alchemy: Thaumaturgy (root 99059)
    [99059] = { x = 0, y = 0 },
    [100208] = { x = -55, y = 0 },
    [100207] = { x = -55, y = 60 },
    [100206] = { x = 0, y = 60 },
    ...
    -- Jewelcrafting: Gemcutting (root 98614)
    [98614] = { x = 0, y = 0 },
    [98613] = { x = -115, y = 0 },
    [98612] = { x = -180, y = -5 },
    [98611] = { x = -180, y = 55 },
    ...
    [98599] = { x = 145, y = 60 },
    [98598] = { x = 145, y = 0 },
    -- Jewelcrafting: Jewelrycrafting (root 98245)
    [98245] = { x = 0, y = 0 },
    [98244] = { x = -60, y = 0 },
    [98243] = { x = 0, y = 60 },
    [101953] = { x = 55, y = 0 },
    -- Jewelcrafting: Shaping (root 98666)
    [98666] = { x = 0, y = 0 },
    [98665] = { x = -70, y = 5 },
    [98664] = { x = 70, y = 5 },
    [98663] = { x = 0, y = 70 },
    ...
    -- Leatherworking Midnight: Learned Leatherworker (root 107921)
    [107921] = { x = 0, y = 0 },
    [107920] = { x = -53, y = 1 },
    [107919] = { x = 2, y = 51 },
    [107918] = { x = 52, y = 1 },
    -- Leatherworking Midnight: Lasting Leather (root 107889)
    [107889] = { x = 0, y = 0 },
    [107888] = { x = -25, y = 61 },
    [107887] = { x = -85, y = 6 },
    [107886] = { x = -85, y = 61 },
    ...
    [107880] = { x = 90, y = 61 },
    [107879] = { x = 90, y = 1 },
    -- Leatherworking Midnight: Safeguarding Scales (root 107993)
    [107993] = { x = 0, y = 0 },
    [107992] = { x = -25, y = 56 },
    [107991] = { x = -85, y = 6 },
    [107990] = { x = -85, y = 61 },
    ...
    [107984] = { x = 85, y = 56 },
    [107983] = { x = 85, y = 1 },
    -- Leatherworking Midnight: Flawless Fortes (root 107817)
    [107817] = { x = 0, y = 0 },
    [107816] = { x = -51, y = 1 },
    [107815] = { x = 49, y = 1 },
    [107814] = { x = 49, y = 56 },
    [107813] = { x = 99, y = 56 },
    [107812] = { x = 99, y = 1 },
    -- Tailoring Midnight: Sin'dorei Finery (root 104216)
    [104216] = { x = 0, y = 0 },
    [104215] = { x = -52, y = 1 },
    [104214] = { x = -107, y = 1 },
    [104213] = { x = -107, y = 51 },
    ...
    [104205] = { x = 108, y = 56 },
    [104204] = { x = 108, y = 1 },
    -- Tailoring Midnight: Nimble Needlework (root 104328)
    [104328] = { x = 0, y = 0 },
    [104327] = { x = -24, y = 56 },
    [104326] = { x = -29, y = 111 },
    [104325] = { x = 26, y = 56 },
    [104324] = { x = 26, y = 111 },
    -- Tailoring Midnight: Fabric Specialist (root 104350)
    [104350] = { x = 0, y = 0 },
    [104349] = { x = -51, y = 1 },
    [104348] = { x = 49, y = 1 },
    -- Tailoring Midnight: Fiber Arts (root 104390)
    [104390] = { x = 0, y = 0 },
    [104389] = { x = -50, y = 1 },
    [104388] = { x = -25, y = 51 },
    [104387] = { x = 30, y = 51 },
